...
class LessModel(BaseModel):
    ...
    def _next(
        ...
        next_capacity = current_capacity + 7.6e-1 * p * r_adjusted * d - ((current_capacity * 0.01) ** (0.6666)) * 850000 / 143290.0 * v_adjusted / 1000 * d + 0.07 * o - (w / 143290.0)
        next_capacity = min(max(next_capacity, 0.0), 100.0)
